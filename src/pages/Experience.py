...
def layout():
    return html.Div([html.Div([], style = {'height':30}),
                     dcc.Markdown('### Professional Experience', style={'textAlign': 'center'}),
                        ...
                        dbc.Row([
                            ...
                            dbc.Col([
                                html.B('Technical advisor on Agrosat services', style = font_B),
                                dcc.Markdown('   **Nutrición de plantas S.A.** - Tuluá, Colombia',
                        ...
                        dbc.Row([
                            ...
                            dbc.Col([
                                html.B('Independent Professional on research project', style = font_B),
                        ...
                        dbc.Row([
                            ...
                            dbc.Col([
                                html.B('GIS technology advisor', style = font_B),
                                dcc.Markdown('   **Avinal S. A.** - Medellín, Antioquia',
                                             style={'white-space': 'pre-wrap'},
                                             className='ms-3'),
                     ...
                     dbc.Row([dbc.Col([dcc.Markdown('*Jul. 2018 - May 2019*',
                                      ...
                                      width=2),
                              dbc.Col([html.B('Teaching assistant', style = font_B),
                                       dcc.Markdown('   *Environmental Fluid Mechanics* - Professor [J. Plazas](https://www.linkedin.com/in/jplazas)\n'
    ...
    dbc.Row([
        ...
        dbc.Col([html.B('Teaching assistant', style = font_B),
                 dcc.Markdown('   *Geophysics* - Professor [I. Molina](https://www.linkedin.com/in/indira-molina-77123b40)\n'
                              '   **Universidad de Los Andes** - Bogotá, Colombia',
                         style={'white-space': 'pre-wrap'},
                         link_target='_blank',
                         className='ms-3'),
