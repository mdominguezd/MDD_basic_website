...
def layout():
    return dbc.Row([dbc.Col([dcc.Markdown('# Martín Domínguez Durán', className='mt-3'),
                             ...
                             html.Div([html.A('Download my CV', download = 'CV_Martin_Dominguez_Duran.pdf', href='./assets/CV_Martin_Dominguez_Duran.pdf')], style = {'text-align':'center', 'font-family':'bahnschrift'})
